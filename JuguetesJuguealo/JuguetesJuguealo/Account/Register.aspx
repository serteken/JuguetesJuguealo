<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="JuguetesJuguealo.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
  ...
  <div class="page-title fix">
	    ...
	    <div class="header-top">
            <p>&nbsp;</p>
		    <h2 style="font-size:2em;">Registrarse</h2>
            <p>&nbsp;</p>
	    </div>
    ...
    <div class="row">
      <div class="col-md-8">
         <div class="form-horizontal">
                ...
                <h4  style="margin-left:20%;">Crear una nueva cuenta</h4>
                <hr />
